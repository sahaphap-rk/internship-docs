...
Agile Alliance. (2024). _Acceptance Test-Driven Development (ATDD)_. https://www.agilealliance.org/glossary/atdd/

Anoop, M. D. (2024). _Bruno_ [Computer software]. https://www.usebruno.com/

Apple Inc. (2024). _HTTP Live Streaming_ [Computer software]. https://developer.apple.com/streaming/
...
Extreme Programming. (2013). _Extreme Programming: A Gentle Introduction_. http://www.extremeprogramming.org/

FFmpeg Developers. (2024). _FFmpeg_ [Computer software]. https://ffmpeg.org/
...
Google. (2024a). _Angular_ [Computer software]. https://angular.dev/

Google. (2024b). _Google Cloud Storage_ [Computer software]. https://cloud.google.com/storage/
...
Liquibase. (2024). _Liquibase_ [Computer software]. https://www.liquibase.com/
...
Microsoft. (2024a). _TypeScript_ [Computer software]. https://www.typescriptlang.org/
...
Nrwl. (2024). _Nx: Smart Monorepos_ [Computer software]. https://nx.dev/

Object Management Group. (2024). _Unified Modeling Language (UML)_. https://www.omg.org/spec/UML/
...
Scrum.org. (2024). _ATDD, BDD, TDD … What's in a name?_. https://www.scrum.org/resources/blog/atdd-bdd-tdd-whats-name

Shostack, G. L. (1984). _Designing Services That Deliver_. Harvard Business Review, 62(1), 133-139.

Redis Ltd. (2024). _Redis_ [Computer software]. https://redis.io/

Siam Chamnankit. (2024a). _A-DAPT Blueprint_. https://www.sck.co.th/
...
Twilio Inc. (2024). _Twilio SendGrid_ [Computer software]. https://www.twilio.com/sendgrid
