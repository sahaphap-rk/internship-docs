...
ขอบเขตงานที่รับผิดชอบครอบคลุมการพัฒนาทั้งส่วน Frontend และ Backend ของ Enrollment Management Module และ Reporting Module โดยพนักงานสามารถเลือกหลักสูตรและส่งคำขอ#box[ลงทะเบียนเรียนได้] ขณะที่ฝ่ายทรัพยากรบุคคลสามารถพิจารณาอนุมัติหรือปฏิเสธคำขอ มอบหมายหลักสูตรให้พนักงาน รวมทั้งส่งออกรายงานผลการเรียนรู้ในรูปแบบ CSV และดาวน์โหลดประกาศนียบัตรได้อย่างเป็นระบบ นอกจากนี้ ระบบยังรองรับงานประมวลผลเบื้องหลังด้วย Redis และ BullMQ เพื่อลดความล่าช้าในการสร้างไฟล์รายงานและเพิ่มประสิทธิภาพการให้บริการ
...
The scope of work covered both frontend and backend development of the Enrollment Management Module and the Reporting Module. Employees can select courses and submit enrollment requests, while human resources staff can approve or reject requests, assign courses to employees, export learning reports in CSV format, and download certificates systematically. In addition, the system supports background processing with Redis and BullMQ to reduce delays in report file generation and improve service efficiency.
